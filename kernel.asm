...
80100c01:	e8 ba 5d 00 00       	call   801069c0 <freevm>
  return -1;
...
80100cff:	e8 3c 59 00 00       	call   80106640 <switchuvm>
  freevm(oldpgdir);
80100d04:	89 34 24             	mov    %esi,(%esp)
80100d07:	e8 b4 5c 00 00       	call   801069c0 <freevm>
  return 0;
...
80103875:	e8 a6 32 00 00       	call   80106b20 <copyuvm>
...
8010388f:	89 02                	mov    %eax,(%edx)
  *np->tf = *curproc->tf;
80103891:	8b 7a 18             	mov    0x18(%edx),%edi
  np->parent = curproc;
80103894:	89 5a 14             	mov    %ebx,0x14(%edx)
  *np->tf = *curproc->tf;
80103897:	8b 73 18             	mov    0x18(%ebx),%esi
8010389a:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  for(i = 0; i < NOFILE; i++)
8010389c:	31 f6                	xor    %esi,%esi
  np->stacksize = curproc->stacksize;
8010389e:	8b 43 7c             	mov    0x7c(%ebx),%eax
801038a1:	89 42 7c             	mov    %eax,0x7c(%edx)
  np->tf->eax = 0;
801038a4:	8b 42 18             	mov    0x18(%edx),%eax
801038a7:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
...
80105542:	0f 82 08 02 00 00    	jb     80105750 <trap+0x250>
        break;
    }
    //break;
  //PAGEBREAK: 13
...
8010568f:	90                   	nop
    uartintr();
80105690:	e8 8b 02 00 00       	call   80105920 <uartintr>
    lapiceoi();
...
801056ac:	c7 04 24 cc 75 10 80 	movl   $0x801075cc,(%esp)
...
801057e1:	8b 43 30             	mov    0x30(%ebx),%eax
801057e4:	c7 04 24 94 76 10 80 	movl   $0x80107694,(%esp)
801057eb:	89 44 24 04          	mov    %eax,0x4(%esp)
801057ef:	e8 5c ae ff ff       	call   80100650 <cprintf>
      panic("trap");
801057f4:	c7 04 24 c6 75 10 80 	movl   $0x801075c6,(%esp)
801057fb:	e8 60 ab ff ff       	call   80100360 <panic>
...
80106b33:	0f 84 6b 01 00 00    	je     80106ca4 <copyuvm+0x184>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106b39:	8b 55 0c             	mov    0xc(%ebp),%edx
80106b3c:	85 d2                	test   %edx,%edx
...
80106ba7:	0f 84 0a 01 00 00    	je     80106cb7 <copyuvm+0x197>
    if(!(*pte & PTE_P))
80106bad:	8b 30                	mov    (%eax),%esi
80106baf:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106bb5:	0f 84 f0 00 00 00    	je     80106cab <copyuvm+0x18b>
    pa = PTE_ADDR(*pte);
...
80106bfb:	bb 00 f0 ff 7f       	mov    $0x7ffff000,%ebx
80106c00:	eb 58                	jmp    80106c5a <copyuvm+0x13a>
...
80106c5d:	31 c9                	xor    %ecx,%ecx
80106c5f:	89 da                	mov    %ebx,%edx
80106c61:	e8 4a f7 ff ff       	call   801063b0 <walkpgdir>
80106c66:	85 c0                	test   %eax,%eax
80106c68:	74 4d                	je     80106cb7 <copyuvm+0x197>
    if(!(*pte & PTE_P))
80106c6a:	8b 30                	mov    (%eax),%esi
80106c6c:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106c72:	74 37                	je     80106cab <copyuvm+0x18b>
    pa = PTE_ADDR(*pte);
80106c74:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106c76:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106c7c:	89 75 e4             	mov    %esi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106c7f:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106c85:	e8 06 b8 ff ff       	call   80102490 <kalloc>
80106c8a:	85 c0                	test   %eax,%eax
80106c8c:	89 c6                	mov    %eax,%esi
80106c8e:	0f 85 74 ff ff ff    	jne    80106c08 <copyuvm+0xe8>
80106c94:	e9 42 ff ff ff       	jmp    80106bdb <copyuvm+0xbb>
80106c99:	8b 45 e0             	mov    -0x20(%ebp),%eax
}
80106c9c:	83 c4 2c             	add    $0x2c,%esp
80106c9f:	5b                   	pop    %ebx
80106ca0:	5e                   	pop    %esi
80106ca1:	5f                   	pop    %edi
80106ca2:	5d                   	pop    %ebp
80106ca3:	c3                   	ret    
    return 0;
80106ca4:	31 c0                	xor    %eax,%eax
80106ca6:	e9 3d ff ff ff       	jmp    80106be8 <copyuvm+0xc8>
      panic("copyuvm: page not present");
80106cab:	c7 04 24 c2 78 10 80 	movl   $0x801078c2,(%esp)
80106cb2:	e8 a9 96 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106cb7:	c7 04 24 a8 78 10 80 	movl   $0x801078a8,(%esp)
80106cbe:	e8 9d 96 ff ff       	call   80100360 <panic>
